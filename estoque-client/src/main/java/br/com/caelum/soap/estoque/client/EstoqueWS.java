...
public interface EstoqueWS {
     ...
     * @param filtros
     * @return
     *     returns br.com.caelum.soap.estoque.client.ListaItens
     */
    ...
    @RequestWrapper(localName = "TodosOsItens", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.caelum.soap.estoque.client.TodosOsItens")
    @ResponseWrapper(localName = "TodosOsItensResponse", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.caelum.soap.estoque.client.TodosOsItensResponse")
     ...
     * @param parameters
     * @return
     *     returns br.com.caelum.soap.estoque.client.CadastrarItemResponse
